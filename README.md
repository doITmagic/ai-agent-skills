...
| [spec-driven-development](skills/spec-driven-development/) | 3-phase requirements, design, and task planning workflow | `methodology` `requirements` `design` |
| [hermes-tweet](skills/hermes-tweet/) | Hermes Tweet workflows for X/Twitter research, monitoring, audits, and approval-gated account actions | `hermes` `twitter` `x` |
| **- Trello Integration -** | | |
